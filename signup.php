...
function validateEmailWithZeroBounce($email) {
    $apiKey = 'd00f1ee3460740e4adc7db20d42dd1dd'; // Replace with your ZeroBounce API key
...
if (isset($_POST['btnsignup'])) {
    ...
    $emailValidationResult = validateEmailWithZeroBounce($email);

    if ($emailValidationResult['status'] !== 'valid') {
        echo '<script>alert("Invalid email address: ' . htmlspecialchars($emailValidationResult['status']) . '");</script>';
    } else {
